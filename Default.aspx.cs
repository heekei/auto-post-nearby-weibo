    ...
    public partial class Default : System.Web.UI.Page
    {
        ...
        public string get_poi_timeline()
        {
            try
            {
                ...
                string str = HttpGet("https://api.weibo.com/2/place/poi_timeline.json", "source=664411323&access_token=2.00XoGYyC0fjnxi67e82f9350ft9dQE&poiid="+poiid+"&since_id=" + since_id + "&count=10&page=1");
                if (str.Length <= 2)
                {
                    WriteLog("null");
                ...
                else
                {
                    try
                    {
                        ...
                        foreach (poi_timeline.Status c in timeline.statuses)
                        {
							...
							int l = pic_ids.Length;
							if(l>0){
								pic_ids=pic_ids.Substring(0, pic_ids.Length - 1);
